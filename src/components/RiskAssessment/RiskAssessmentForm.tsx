...
import { Calculator, PoundSterling, ArrowLeft, ArrowRight } from "lucide-react";
...
const steps = [
  ...
  {
    title: "IT Provider Information",
    description: "Tell us about your current IT support."
  },
  {
    title: "Business Details",
    description: "Tell us about your business so we can tailor the assessment."
  },
  {
    title: "Security Practices",
    description: "Assess your current security measures."
  },
  {
    title: "Compliance and Support",
    description: "Assess your compliance and support needs."
  }
];
        ...
        {steps.map((step, index) => (
          <React.Fragment key={index}>
            <div className="flex flex-col items-center">
              ...
              <span className={`mt-2 text-sm ${index === currentStep ? 'text-primary font-medium' : 'text-gray-500'}`}>
                {step.title}
              </span>
            </div>
  ...
  const renderForm = () => (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        {currentStep === 1 && renderITProvider()}
        {currentStep === 2 && renderBusinessDetails()}
        {currentStep === 3 && renderSecurityPractices()}
        {currentStep === 4 && renderComplianceSupport()}
      </form>
    </Form>
  );
